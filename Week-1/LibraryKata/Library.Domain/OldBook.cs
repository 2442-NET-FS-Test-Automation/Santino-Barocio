...
public class OldBook
{
    ...
    //Beacause I want to use a no-arg constructor, its best practice to make
    // my propperties nullable "?"
    ...
    public int Id {get;} //No setter, I don't want someoneto reassign this

    // Every class has a very specific method within it
    // Te constructor - you can have as many as you need/want
    ...
    public bool Chekout()
    {
        ...
        //Otherwise, we pass ober the above code block
    ...
    public override string ToString()
    {
        ...
        //Book's parent is boject, so this is calling the Default ToString()
        //Example:

...
public class LibraryUnitOfWork : IUnitOfWork
{
    ...
    //I want to hold my list of staged changes
    //We will represent those as strings,  this is a shallow demo example

    private readonly List<string> _staged = new();

    //We need a constructor
    //We ae technically using Dependency Injection here. We never instantiate the
    ...
    public int Commit()
    {
        ...
        int count = _staged.Count;//How many thing are in staging at commit time?

...
// All od the code that does the actual SQL generation, creating a connection to my database,
// doing CRUD, updating the DB based on changes to my model - ALL OF THAT lives in class
...
public class LibraryDbContext : DbContext
{
    ...
    // We ourselves will never call this constructor. ASP.NET's DI container will do it for use
    ...
    {
        // I can set anything I want as fas as constraints, mapping column names and types
        // inseide of here usin something called Fluent API. EF Core lets you do config
        ...
        // This order of operations, setting strginf length and the telling BV that a column
        ...
        b.Entity<Product>().HasData(
            ...
            new Product { Id = 3, Sku = "BK-003", Name = "Refactoring", Price = 32.00m}
        );
        ...
        // HasData runs inside the migration BEFORE SQL Server con hand out identity keys

...
public class OrderFactory
{
    ...
    public Order CreateOrder(string kind, int cusotmerId, IEnumerable<(string sku, int qty)> lines)
    {
        switch (kind)
        {
            case "normal":
                return BuildOrder(Priority.Normal, cusotmerId, lines);
            case "expedited":
                return BuildOrder(Priority.Expedited, cusotmerId, lines);
            default:
